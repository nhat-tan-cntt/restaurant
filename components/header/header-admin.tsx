...
export default function HeaderAdmin() {
    return <header className="flex justify-between h-16 shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12">
        ...
        <div className="flex items-center gap-4 px-4">
            ...
            <DropdownMenu>
                <DropdownMenuTrigger className="flex text-left items-center gap-4 p-3 rounded-2xl bg-background border-none shadow-none">
                    <div className="min-w-32 max-w-[160px]">
